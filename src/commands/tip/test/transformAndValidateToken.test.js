...
t.test('Supported token', ({ end }) => {
  ...
  t.ok(token.minimumTip.eq(Hippopotamus.minimumTip), 'Should get minimum tip as BigNumber instance')
  t.equal(token.logo, Hippopotamus.logo, 'Should get logo object')
